...
<body>
    ...
    <div>
        ...
        <asp:Label ID="LabelWelcome" runat="server" Text="Witaj " CssClass="auto-style17" ForeColor="#3333FF"></asp:Label>
                    <br />
                    <br />
                    </strong>
        <asp:Button ID="B_logout" runat="server" OnClick="B_logout_Click" Text="Wyloguj" CssClass="auto-style20" BackColor="#FFFFCC" />
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style2">&nbsp;</td>
                <td class="auto-style30">
                    <asp:GridView ID="GridViewCoach" runat="server" CellPadding="4" DataSourceID="SqlDataSourceCoach" ForeColor="#333333" GridLines="None" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" AutoGenerateColumns="False" AllowPaging="True" DataKeyNames="ID">
